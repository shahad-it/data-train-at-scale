...
**The next parts are optional.** That being said, this is the only challenge of the day, so if you still have time before the recap, continue with part 5.

# 5️⃣ [Optional] Incremental Processing
...
# 6️⃣ [Optional] Incremental Learning
